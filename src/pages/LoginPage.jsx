      ...
      <div className="mx-auto flex min-h-[calc(100vh-3rem)] max-w-6xl overflow-hidden rounded-[28px] bg-white shadow-2xl sm:min-h-[calc(100vh-5rem)] sm:rounded-[36px]">
        ...
        <div className="flex w-full items-center justify-center p-6 sm:p-12 lg:w-1/2">
          <div className="w-full max-w-md">
            ...
            <div className="mb-8">
              <p className="text-sm font-semibold uppercase tracking-[0.18em] text-taskor-purple">Welcome back</p>
              <h1 className="mt-3 text-4xl font-extrabold tracking-tight text-taskor-ink">Log in to Taskor</h1>
            ...
            <p className="mt-6 text-sm text-taskor-slate">
              ...
              <Link to="/signup" className="font-semibold text-taskor-purple hover:underline">Create one</Link>
            </p>
          </div>
        </div>
      </div>
